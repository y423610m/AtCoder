...
namespace detail
{
      ...
      enum
 {
  ...
  template<typename T1>
    struct create1
    {
      typedef node<__gnu_cxx::typelist::chain<T1, __gnu_cxx::typelist::null_type> > type;
    };

  template<typename T1, typename T2>
    struct create2
    {
      typedef node<__gnu_cxx::typelist::chain<T1, __gnu_cxx::typelist::chain<T2, __gnu_cxx::typelist::null_type> > > type;
    };

  template<typename T1, typename T2, typename T3>
    struct create3
    {
      typedef node<__gnu_cxx::typelist::chain<T1, __gnu_cxx::typelist::chain<T2, __gnu_cxx::typelist::chain<T3, __gnu_cxx::typelist::null_type> > > > type;
    };

  template<typename T1, typename T2, typename T3, typename T4>
    struct create4
    {
      typedef node<__gnu_cxx::typelist::chain<T1, __gnu_cxx::typelist::chain<T2, __gnu_cxx::typelist::chain<T3, __gnu_cxx::typelist::chain<T4, __gnu_cxx::typelist::null_type> > > > > type;
    };
  ...
  template<typename T1, typename T2, typename T3,
    ...
    struct create5
    {
      typedef node<__gnu_cxx::typelist::chain<T1, __gnu_cxx::typelist::chain<T2, __gnu_cxx::typelist::chain<T3, __gnu_cxx::typelist::chain<T4, __gnu_cxx::typelist::chain<T5, __gnu_cxx::typelist::null_type> > > > > > type;
    };
  ...
  template<typename T1, typename T2, typename T3,
    ...
    struct create6
    {
      typedef node<__gnu_cxx::typelist::chain<T1, __gnu_cxx::typelist::chain<T2, __gnu_cxx::typelist::chain<T3, __gnu_cxx::typelist::chain<T4, __gnu_cxx::typelist::chain<T5, __gnu_cxx::typelist::chain<T6, __gnu_cxx::typelist::null_type> > > > > > > type;
    };
}
