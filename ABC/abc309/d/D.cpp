...
void solve() {
   ...
   Graph<int> G(N1+N2, E, false, false);//directed? reverse?

   Dijkstra<int> d1(N1+N2, INF);
   d1.solve(G, 0, -1, false);
   Dijkstra<int> d2(N1+N2, INF);
   d2.solve(G, N1+N2-1, -1, false);


   ll dist1 = 0;
   rep(i,N1) chmax(dist1, d1.dist[i]);
   ll dist2 = 0;
   rep(i,N2) chmax(dist2, d2.dist[i+N1]);
