...
#include "graph/tree/rerooting_dp_tmp.hpp"
namespace RDP{
...
void solve() {
   ...
   auto Merge = [&](ll a, ll b)->ll {return max<ll>(a,b);};
   auto El = [&](int p, bool canAffectSelf = false)->ll {
      if(canAffectSelf) return 0;
      return D[p];
   };
   auto PE = [&](ll v, Edge<ll>& e)->ll {return v + e.cost;};
   auto PV = [&](ll e, int p)->ll {return e;};
